...
-- Mount loader
do
	local url = "https://github.com/Sleitnick/RbxCameraShaker/tree/master/src/CameraShaker"
	local entry = EntryUtils.create("Folder", "CameraShaker", "")
...
print("Done installing CameraShaker")